...
export default function DocumentDetail(props) {
  ...
  useEffect(async () => {
    let fileData;
    await axios.get(`http://localhost:8000/documents/${selectedFileId}`, {
      headers: {
  ...
  const retrieveSignedUrl = async () => {
    ...
    selectedFileId && await axios.get(`http://localhost:8000/documents/presignedUrl/${selectedFileId}`, {
      headers: {
  ...
  const updateDocument = async () => {
    ...
    selectedFileId && await axios.post(`localhost:8000/documents/${selectedFileId}`, data).then(res => {
